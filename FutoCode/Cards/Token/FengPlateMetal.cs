...
public sealed class FengPlateMetal : FutoCard
{
    ...
    {
        await CommonActions.ApplySelf<FengMetalPower>(this, DynamicVars["FengMetalPower"].BaseValue);
    }

    protected override void OnUpgrade()
    {
        DynamicVars["FengMetalPower"].UpgradeValueBy(1m);
    }
        ...
        CombatState combatState)
    {
        ...
        for (int index = 0; index < count; ++index)
            plates.Add((CardModel) combatState.CreateCard<FengPlateMetal>(owner));
