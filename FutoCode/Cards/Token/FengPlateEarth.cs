...
public sealed class FengPlateEarth : FutoCard
{
    ...
    {
        await CommonActions.ApplySelf<FengEarthPower>(this, DynamicVars["FengEarthPower"].BaseValue);
    }
    protected override void OnUpgrade()
    {
        DynamicVars["FengEarthPower"].UpgradeValueBy(1m);
    }
